...
TEST_CASE("GotoIfLessOrEqual pops 3 values off the Stack (label, a, b), interprets a & b as int, if (a <= b) it executes a go_to_line on the Context", "[GotoIfLessOrEqual]") {
  label_t label = 1;
